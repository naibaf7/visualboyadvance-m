...
opt_desc opts[] = {
	...
	INTOPT("preferences/EmulatorSpeedupToggle", "EmulatorSpeedupToggle", wxTRANSLATE("Emulator speedup toggle"), turbo, 0, 1),
    ...
    UINTOPT("preferences/throttle", "", wxTRANSLATE("Throttle game speed, even when accelerated (x%, 0 = no throttle)"), throttle, 0, 1000000),
    UINTOPT("preferences/speedupThrottle", "", wxTRANSLATE("Set throttle for speedup key (x%, 0 = no throttle)"), speedup_throttle, 0, 1000000),
